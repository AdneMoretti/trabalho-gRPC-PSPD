...
class DictionaryServiceStub(object):
    ...
    def __init__(self, channel):
        ...
        """
        self.ProcessWord = channel.unary_unary(
...
class DictionaryServiceServicer(object):
    ...
    def ProcessWord(self, request, context):
        """Missing associated documentation comment in .proto file."""
...
def add_DictionaryServiceServicer_to_server(servicer, server):
    rpc_method_handlers = {
            'ProcessWord': grpc.unary_unary_rpc_method_handler(
                    servicer.ProcessWord,
